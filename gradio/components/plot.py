...
class Plot(Component):
    ...
    def __init__(
        ...
        value: Any | None = None,
        *,
        format: str = "webp",  # webp is a good default for speed (see #7845) but can't be used in Wasm because the version of matplotlib used in Wasm (3.5.2 in the case of Pyodide 0.26.1) doesn't support it.
